...
public class ServiceTest {
	...
	private static final String mainPath = "akg/";
	...
	public void startServer() throws Exception {
		...
		node.startService(new ServiceNameVersion(akgService.class.getName(), "1.0.0"), "a pass");
	...
	/**
	 * 
	 * Test the example method that consumes one path parameter which we give the
	 * value "testInput" in this test.
	 * 
	 */
	@Test
